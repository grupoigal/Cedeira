...
public class Eventos extends AppCompatActivity
    ...
    private static String url_all_eventos = "https://cedeira.000webhostapp.com/conexion/buscar_eventos.php";
    ...
    String[] fechaArray= new String[25];
    String[] horaArray= new String[25];
    String[] lugarArray= new String[25];
    String[] enlace_pdf1_Array= new String[25];
    String[] enlace_pdf2_Array= new String[25];
    ...
    class LoadAllEventos extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog.setMessage("Cargando eventos. Por favor espere...");
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    for (int i = 0; i < eventos.length(); i++) {
                        ...
                        String enlace_pdf_2 = c.getString(TAG_ENLACE_PDF2);
                        enlace_pdf2_Array[i] = enlace_pdf_2;
                ...
                public void run() {
                    ...
                    lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            i.putExtra("lugar", lugarArray[identificador] );
                            i.putExtra("fecha", fechaArray[identificador] );
                            i.putExtra("tiempo", horaArray[identificador] );
                            i.putExtra("enlace1", enlace_pdf1_Array[identificador] );
                            i.putExtra("enlace2", enlace_pdf2_Array[identificador] );
                            startActivity(i);
