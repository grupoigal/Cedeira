...
public class MainActivity extends AppCompatActivity
    ...
    //Al pulsar btnConcello
    public void irConcello(View view)
    {
        Intent concello = new Intent(getApplicationContext(),MainConcello.class);
        view.startAnimation(AnimationUtils.loadAnimation(this, R.anim.anim_item));
        startActivityForResult(concello, 0);
    }
    //Al pulsar btnTurismo
    public void irTurismo(View view)
    {
        Intent turismo = new Intent(getApplicationContext(),MainTurismo.class);
        view.startAnimation(AnimationUtils.loadAnimation(this, R.anim.anim_item));
        startActivityForResult(turismo, 0);
    }
    //Al pulsar btnSanAndres
    public void irSanAndres(View view)
    {
        Intent san_andres = new Intent(getApplicationContext(),Turismo.class);
        san_andres.putExtra("turismo", 4);
        view.startAnimation(AnimationUtils.loadAnimation(this, R.anim.anim_item));
        startActivityForResult(san_andres, 0);
    }
    //Al pulsar btnActualidade
    public void irActualidade(View view)
    {
        Intent actualidad = new Intent(getApplicationContext(),Actualidade.class);
        view.startAnimation(AnimationUtils.loadAnimation(this, R.anim.anim_item));
        startActivityForResult(actualidad, 0);
    }
    //Al pulsar btnQR
    public void irQR(View view)
    {
        Intent qr = new Intent(getApplicationContext(),MainQR.class);
        view.startAnimation(AnimationUtils.loadAnimation(this, R.anim.anim_item));
        startActivityForResult(qr, 0);
    }
    //Al pulsar btnParticipa
    public void irParticipa(View view)
    {
        Intent participa = new Intent(getApplicationContext(),MainParticipa.class);
        view.startAnimation(AnimationUtils.loadAnimation(this, R.anim.anim_item));
        startActivityForResult(participa, 0);
    }
