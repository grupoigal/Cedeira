...
public class Rutas_San_Andres extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rutas__san__andres);
    ...
    public void irCaminoDoMar(View view) {
    ...
    public void irCaminoVello(View view) {
        Intent i = new Intent(getApplicationContext(), CargaWeb.class);
        i.putExtra("id", 1);
        startActivity(i);
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
    ...
    public void irTeixidoDendePortoDoCabo(View view) {
        Intent i = new Intent(getApplicationContext(), CargaWeb.class);
        i.putExtra("id", 2);
        startActivity(i);
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
    ...
    public void irCarinoTeixido(View view) {
        Intent i = new Intent(getApplicationContext(), CargaWeb.class);
        i.putExtra("id", 3);
        startActivity(i);
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
    ...
    public void irMedievo(View view) {
        Intent i = new Intent(getApplicationContext(), CargaWeb.class);
        i.putExtra("id", 4);
        startActivity(i);
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
    ...
    public void irPeiraos(View view) {
        Intent i = new Intent(getApplicationContext(), CargaWeb.class);
        i.putExtra("id", 5);
        startActivity(i);
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
    ...
    public void irPerelinaxes(View view) {
        Intent i = new Intent(getApplicationContext(), CargaWeb.class);
        i.putExtra("id", 6);
        startActivity(i);
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
    ...
    public void irVueltaEspana(View view) {
        Intent i = new Intent(getApplicationContext(), CargaWeb.class);
        i.putExtra("id", 7);
        startActivity(i);
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
